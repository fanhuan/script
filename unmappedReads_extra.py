...
#selected = set(tags1) & set(tags2) #intersection
selected = set(tags1) | set(tags2) #union

out1 = gzip.open(name + '_R1_extra.fq.gz','wt')
out2 = gzip.open(name + '_R2_extra.fq.gz','wt')
