...
int main(int argc, char* argv[])
{
	...
	cout<<"Command:"<<endl;
	cout<<"ProgramFile  -k INPUT_FILE1 -o OUTPUT_FILENAME -s SINGLE_END_FILE_INPUT -s1 QUERY_PAIR1 -s2 QUERY_PAIR2 -fa CONVERT_FQ2FA -MinMatch MINIMUM_MATCHING_KMERS_PER_READ"<<endl;
